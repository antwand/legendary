...
function RichText:addItem(item, isWrap)
	...
	--print("size:".."x:"..(parentSize.height - size.height - self.lowerBoundary)..","..(parentSize.height - size.height - self.lowerBoundary));
...
--[[
function RichText:jumpToPercentVertical(pec)
